        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'WhoIAm',
              path: 'whoIAm',
              builder: (context, params) => WhoIAmWidget(),
            ),
            FFRoute(
              name: 'PreSales',
              path: 'preSales',
              builder: (context, params) => PreSalesWidget(),
            ),
            FFRoute(
              name: 'TechnicaDelivery',
              path: 'technicaDelivery',
              builder: (context, params) => TechnicaDeliveryWidget(),
            ),
            FFRoute(
              name: 'BusinessDevelopment',
              path: 'businessDevelopment',
              builder: (context, params) => BusinessDevelopmentWidget(),
            ),
            FFRoute(
              name: 'PartnerEnablement',
              path: 'partnerEnablement',
              builder: (context, params) => PartnerEnablementWidget(),
            ),
            FFRoute(
